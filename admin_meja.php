...
$sql = "SELECT * FROM meja ORDER BY Nomor ASC";
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <div class="nav-item">
                <a href="admin_meja.php" class="nav-link active">
    ...
    <div class="content">
        <div class="page-header">
            <h2 class="page-title"><i class="fas fa-clipboard-list"></i> Kelola Meja</h2>
            <a href="admin_tambah_meja.php" class="btn btn-primary btn-add">
        ...
        <div class="card main-card">
            <div class="card-header">
                <h5><i class="fas fa-list"></i> Daftar Meja</h5>
            </div>
            <div class="card-body">
                <div class="table-container">
                    <table id="mejaTable" class="table table-hover dataTable text-center">
                        <thead>
                            <tr>
                                <th>Nomor Meja</th>
                                <th>Status</th>
                            ...
                            <?php if ($result->num_rows > 0): ?>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin_hapus_meja.php?nomor_meja=<?= urlencode($row['Nomor']); ?>"
