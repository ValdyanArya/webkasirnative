...
$sql_users = "SELECT COUNT(*) as total_users FROM Pelanggan";
...
<head>
    ...
    <title>Waiter Dashboard | Bass Restoran</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            <div class="nav-item">
                <a href="waiter_dashboard.php" class="nav-link active">
    ...
    <div class="content">
        <div class="header">
            <div>
                <h2>Selamat Datang, Waiter!</h2>
                <p class="welcome-text">Kelola restoran dengan mudah melalui dashboard ini</p>
            </div>
        </div>
